# Documentation Responsibility and Structure

## Purpose

This internal specification defines the responsibility boundary between the internal `project/` workspace and the public `docs/` package, then defines the standard public documentation section structure.

AI agents and developers must use this rule before choosing a document location:
...
## Template vs Fresh-Project Context

### Vib Project Template repository

The template intentionally tracks `project/` governance documents and placeholders because they define the internal workspace structure inherited by generated projects. `docs/` remains the public documentation package.

### Fresh project created from the template

The generated project's `project/` directory is its private/internal development and management workspace. Its `docs/` directory is the public/user documentation package. Project-specific private records must not be copied into public documentation.

## What Belongs in `project/`

Use `project/` for internal material such as planning, architecture, ADRs, research, specifications, development guidelines, AI/developer instructions, controlled update records, implementation records, progress records, and other project-management context.

## What Belongs in `docs/`

Use `docs/` only for verified public information that helps users understand, configure, use, operate, troubleshoot, or follow releases of the actual project.

The current public documentation structure is:
...
> **Is this document internal or public, and where should it go?**
